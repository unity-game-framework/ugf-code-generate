...
{
    public abstract class CodeGenerateContainerExternalInfo<TMemberInfo> : ICodeGenerateContainerExternalInfo where TMemberInfo : CodeGenerateContainerExternalMemberInfo
    {
